...
class EventUsersAdapter() : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun configureRegisteredUsersViewHolder(vh1: RegisteredUsersViewHolder, position: Int) {
        ...
        if (registeredUsers != null) {
            if (registeredUsers.name == null || registeredUsers.name == "") vh1.name.visibility =
                View.GONE
            else vh1.name.text = "Name: ${registeredUsers.name}"
            if (registeredUsers.celestaid == null || registeredUsers.celestaid == "") vh1.celestaid.visibility =
                View.GONE
            else vh1.celestaid.text = "Celesta ID: ${registeredUsers.celestaid}"
            if (registeredUsers.amount.toString() == "") vh1.amount.visibility = View.GONE
            else vh1.amount.text = "Amount: ${registeredUsers.amount.toString()}"
            if (registeredUsers.phone == "" || registeredUsers.phone == null) vh1.phone.visibility =
                View.GONE
            else vh1.phone.text = "Phone: ${registeredUsers.phone}"
        }
    }
    ...
    fun configureTeamDetailsViewHolder(vh2: TeamDetailsViewHolder, position: Int) {
        ...
        if (teamDetails != null) {
            ...
            else vh2.teamName.visibility = View.GONE
            if (teamDetails.amount.toString() != "" && teamDetails.amount != null) vh2.amount.text =
                "Amount: ${teamDetails.amount.toString()}"
            else vh2.amount.visibility = View.GONE

            if (teamDetails.cap_name != "" && teamDetails.cap_name != null) vh2.capName.text =
                "Captain Name: ${teamDetails.cap_name}"
            else vh2.capName.visibility = View.GONE
            if (teamDetails.cap_celestaid != "" && teamDetails.cap_celestaid != null) vh2.capCelestaId.text =
                "Captain Celesta ID: ${teamDetails.cap_celestaid}"
            else vh2.capCelestaId.visibility = View.GONE
            if (teamDetails.cap_phone != "" && teamDetails.cap_phone != null) vh2.capPhone.text =
                "Captain Phone: ${teamDetails.cap_phone}"
            else vh2.capPhone.visibility = View.GONE
            if (teamDetails.cap_email != "" && teamDetails.cap_email != null) vh2.capEmail.text =
                "Captain Email: ${teamDetails.cap_email}"
            else vh2.capEmail.visibility = View.GONE

            if (teamDetails.mem1_name != "" && teamDetails.mem1_name != null) vh2.mem1Name.text =
                "Member 2 name: " + teamDetails.mem1_name
            else vh2.mem1Name.visibility = View.GONE
            if (teamDetails.mem1_celestaid != "" && teamDetails.mem1_celestaid != null) vh2.mem1CelestaId.text =
                "Member 2 Celesta ID: " + teamDetails.mem1_celestaid
            else vh2.mem1CelestaId.visibility = View.GONE
            if (teamDetails.mem1_phone != "" && teamDetails.mem1_phone != null) vh2.mem1Phone.text =
                "Member 2 Phone: " + teamDetails.mem1_phone
            else vh2.mem1Phone.visibility = View.GONE
            if (teamDetails.mem1_email != "" && teamDetails.mem1_email != null) vh2.mem1Email.text =
                "Member 2 Email: " + teamDetails.mem1_email
            else vh2.mem1Email.visibility = View.GONE

            if (teamDetails.mem2_name != "" && teamDetails.mem2_name != null) vh2.mem2Name.text =
                "Member 3 name: " + teamDetails.mem2_name
            else vh2.mem2Name.visibility = View.GONE
            if (teamDetails.mem2_celestaid != "" && teamDetails.mem2_celestaid != null) vh2.mem2CelestaId.text =
                "Member 3 Celesta ID: " + teamDetails.mem2_celestaid
            else vh2.mem2CelestaId.visibility = View.GONE
            if (teamDetails.mem2_phone != "" && teamDetails.mem2_phone != null) vh2.mem2Phone.text =
                "Member 3 Phone: " + teamDetails.mem2_phone
            else vh2.mem2Phone.visibility = View.GONE
            if (teamDetails.mem2_email != "" && teamDetails.mem2_email != null) vh2.mem2Email.text =
                "Member 3 Email: " + teamDetails.mem2_email
            else vh2.mem2Email.visibility = View.GONE

            if (teamDetails.mem3_name != "" && teamDetails.mem3_name != null) vh2.mem3Name.text =
                "Member 4 name: " + teamDetails.mem3_name
            else vh2.mem3Name.visibility = View.GONE
            if (teamDetails.mem3_celestaid != "" && teamDetails.mem3_celestaid != null) vh2.mem3CelestaId.text =
                "Member 4 Celesta ID: " + teamDetails.mem3_celestaid
            else vh2.mem3CelestaId.visibility = View.GONE
            if (teamDetails.mem3_phone != "" && teamDetails.mem3_phone != null) vh2.mem3Phone.text =
                "Member 4 Phone: " + teamDetails.mem3_phone
            else vh2.mem3Phone.visibility = View.GONE
            if (teamDetails.mem3_email != "" && teamDetails.mem3_email != null) vh2.mem3Email.text =
                "Member 4 Email: " + teamDetails.mem3_email
            else vh2.mem3Email.visibility = View.GONE

            if (teamDetails.mem4_name != "" && teamDetails.mem4_name != null) vh2.mem4Name.text =
                "Member 5 name: " + teamDetails.mem4_name
            else vh2.mem4Name.visibility = View.GONE
            if (teamDetails.mem4_celestaid != "" && teamDetails.mem4_celestaid != null) vh2.mem4CelestaId.text =
                "Member 5 Celesta ID: " + teamDetails.mem4_celestaid
            else vh2.mem4CelestaId.visibility = View.GONE
            if (teamDetails.mem4_phone != "" && teamDetails.mem4_phone != null) vh2.mem4Phone.text =
                "Member 5 Phone: " + teamDetails.mem4_phone
            else vh2.mem4Phone.visibility = View.GONE
            if (teamDetails.mem4_email != "" && teamDetails.mem4_email != null) vh2.mem4Email.text =
                "Member 5 Email: " + teamDetails.mem4_email
            else vh2.mem4Email.visibility = View.GONE
        }
    }
